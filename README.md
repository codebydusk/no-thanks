...
- **Widget Theme** — 4 themes: Nothing OS, Golden Silence, OLED, System
...
| **OLED** | Pure black (`#000000`) bg · off-white (`#dcdcdc`) text · grey (`#555555`) nav · **dark green** (`#1b512d`) refresh | *Always dark* |
