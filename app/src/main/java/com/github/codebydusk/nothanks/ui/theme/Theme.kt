...
// ── Nothing OS ──────────────────
private val NothingDark = buildDuoToneColorScheme(Color(0xFFD71921), Color(0xFF1B1B1D), true)
private val NothingLight = buildDuoToneColorScheme(Color(0xFFD71921), Color(0xFFFDFBFF), false)
